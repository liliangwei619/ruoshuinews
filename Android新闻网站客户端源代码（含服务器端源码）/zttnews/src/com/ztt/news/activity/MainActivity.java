...
import com.szy.news.model.Category;
import com.szy.news.service.SyncHttp;
import com.ztt.news.custom.CustomSimpleAdapter;
import com.ztt.news.util.DensityUtil;
import com.ztt.news.util.StringUtil;
